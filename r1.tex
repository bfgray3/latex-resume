...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: Python, C++, SQL, R (not recent), Bash} \\
     \textbf{Frameworks/Packages}{: Spark, NumPy, pandas, FastAPI, scikit-learn, dbt (limited)} \\
     \textbf{Tools}{: Git, Docker, *nix command line} \\
     \textbf{Cloud}{: AWS (Certifications: Solutions Architect Associate exp. December 2023, Machine Learning Specialty exp. May 2024)} \\
    }}
     \textbf{Data Science}{: machine/statistical learning, deep learning, natural language processing, A/B testing} \\
